    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        if let rangeOfFirstLine = text.range(of: "^.*?(?:\n|$)", options: .regularExpression) {
            ...
            let titleAttributes: [NSAttributedString.Key: Any] = [
                .font: UIFont.boldSystemFont(ofSize: FontSizes.subheader) // Увеличьте размер шрифта здесь
            ]
            ...
            if nsRange.upperBound < text.utf16.count {
                ...
                attributedText.addAttributes([.font: UIFont.systemFont(ofSize: FontSizes.body)], range: restRange)
            }
        }
